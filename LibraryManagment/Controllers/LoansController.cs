...
namespace LibraryManagment.Controllers
{
    public class LoansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,LoanDate,ReturnDate,BookId,UserId")] Loan loan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LoanDate,ReturnDate,BookId,UserId")] Loan loan)
        {
            if (id != loan.ID)
            {
                return NotFound();
